...
class BinaryTunnel {
    ...
    drawAccretionDisk() {
        ...
        gradient.addColorStop(0, 'rgba(255, 140, 80, 0)');       // Inner edge - transparent
        gradient.addColorStop(0.3, 'rgba(255, 140, 80, 0.12)');  // Fade in
        gradient.addColorStop(0.5, 'rgba(255, 150, 90, 0.18)');  // Middle - solid
        gradient.addColorStop(0.7, 'rgba(255, 140, 80, 0.12)');  // Fade out
        gradient.addColorStop(1, 'rgba(255, 140, 80, 0)');       // Outer edge - transparent
        ...
        this.ctx.strokeStyle = 'rgba(255, 200, 150, 0.15)';
