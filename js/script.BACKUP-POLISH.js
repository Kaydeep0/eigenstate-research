...
class BinaryTunnel {
    ...
    createParticle(z = 2000) {
        const isOrange = Math.random() < 0.08; // 8% chance orange
        return {
    ...
    drawEmergingPattern() {
        ...
        // Pulse opacity between 0.04 and 0.10
        this.patternOpacity = 0.04 + Math.sin(this.patternPhase) * 0.03;
        ...
        this.ctx.fillStyle = `rgba(255, 107, 53, ${this.patternOpacity * 0.8})`;
