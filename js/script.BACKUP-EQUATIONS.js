...
class BinaryTunnel {
    ...
    drawEmergingPattern() {
        ...
        // Schrödinger equation (top)
        this.ctx.fillStyle = `rgba(255, 107, 53, ${this.patternOpacity * 2.5})`;
        this.ctx.font = '11px "JetBrains Mono", monospace';
        this.ctx.textAlign = 'center';
        this.ctx.fillText('Ĥψ = iℏ∂ψ/∂t', cx, cy - 85);
        
        // Pattern to Structure equation (bottom)
        this.ctx.fillText('S(t) = ∫P(x)dx → Structure', cx, cy + 95);
