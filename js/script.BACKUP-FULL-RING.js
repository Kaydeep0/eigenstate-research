...
class BinaryTunnel {
    constructor(canvasId) {
        ...
        this.equations = [
            { text: 'H = -Σp(x)log p(x)', angle: 0, dist: 0, delay: 0.5, formProgress: 0, atEdge: false },
            { text: 'P(A|B) = P(B|A)P(A)/P(B)', angle: Math.PI * 0.5, dist: 0, delay: 0.8, formProgress: 0, atEdge: false },
            { text: '∂²ψ/∂t² = c²∇²ψ', angle: Math.PI, dist: 0, delay: 1.1, formProgress: 0, atEdge: false },
            { text: 'θ = θ - α∇J(θ)', angle: Math.PI * 1.5, dist: 0, delay: 1.4, formProgress: 0, atEdge: false },
            { text: '∇ × E = -∂B/∂t', angle: Math.PI * 0.25, dist: 0, delay: 1.7, formProgress: 0, atEdge: false },
            { text: 'E = mc²', angle: Math.PI * 0.75, dist: 0, delay: 2.0, formProgress: 0, atEdge: false },
            { text: 'F = ma', angle: Math.PI * 1.25, dist: 0, delay: 2.3, formProgress: 0, atEdge: false },
            { text: 'S = k log W', angle: Math.PI * 1.75, dist: 0, delay: 2.6, formProgress: 0, atEdge: false }
        ];
        this.equationTime = 0;
    ...
    drawFloatingEquations() {
        ...
        const edgeDist = Math.min(this.canvas.width, this.canvas.height) * 0.42;
