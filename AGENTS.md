...
1. Federation `llms.txt` (above) — or Pages mirror: [`llms.txt`](https://kaydeep0.github.io/eigenstate-research/llms.txt)
...
6. Human research: https://kaydeep0.github.io/eigenstate-research/
