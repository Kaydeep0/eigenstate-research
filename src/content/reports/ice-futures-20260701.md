...
The field is 0.1172 below equilibrium coherence. Each entity with measured vault activity raises the global PT toward 0.618. ICE Futures — Brent crude benchmarks does not yet have a complete observation record on the M1 topology (199 entities).
...
*Source-checked: ATTESTED-PRIMARY · custody sha256 3c1f7fc53d3f… — found in primary source*

**ICE energy futures and options** [○ UNVERIFIED-PENDING]
...
*Source-checked: UNVERIFIED-PENDING · custody sha256 7ddb02626fa9… — source unreachable (status=404)*
...
**node:** `34539544`
**entity:** `ICE_FUTURES`
**report_id:** `ICE_FUTURES_20260701`
**canonical_report:** https://kaydeep0.github.io/eigenstate-research/reports/report.html?id=ICE_FUTURES_20260701
...
| This report | [This report](https://kaydeep0.github.io/eigenstate-research/reports/report.html?id=ICE_FUTURES_20260701) |

**Build fingerprint:** `0be5abe082f8a27a…` — match `builds[].chain_hash` for `ICE_FUTURES` in manifest, then verify via `/api/chain`.
**Granth head:** `586bdbd7677232ab…` · length 2499
...
- Canonical report: https://kaydeep0.github.io/eigenstate-research/reports/report.html?id=ICE_FUTURES_20260701
- Build fingerprint: `0be5abe082f8a27a…` (match manifest `builds[].chain_hash`)
...
*Generated: 2026-07-01T23:10:30 UTC by Eigenstate engine · ICE Futures — Brent crude benchmarks · 2026-07-01*