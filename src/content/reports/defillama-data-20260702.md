---
id: "DEFILLAMA_DATA_20260702"
entity_display: "DeFiLlama"
date: "July 02, 2026"
date_iso: "2026-07-02"
phi_s: 0.02
kappa: 0.0185
vault_records: 0
entity_codename: "DEFILLAMA_DATA"
display_kind: "data_provider"
facet_label: "Data / Oracles"
public_default: true
demoted: false
---
# DeFiLlama: Field Position Report
...
The field is 0.1172 below equilibrium coherence. Each entity with measured vault activity raises the global PT toward 0.618. DeFiLlama is one of 203 entities in the field without a complete observation record.

## What Is DeFiLlama

DeFiLlama is an open on-chain data aggregator — indexing protocol TVL, chain activity, and tokenized asset deployment metrics used to cross-check audit and issuer claims across Ethereum, Base, and Arbitrum. For spread-capture topology, DeFiLlama is the data verification waist where post-audit deployment signals must align with attested on-chain metrics.
...
Active signals the engine is tracking for DeFiLlama:

**DeFiLlama — on-chain data aggregator homepage** [✓ ATTESTED-PRIMARY]
DeFiLlama's homepage documents open TVL and protocol data — primary anchor for DeFiLlama data claims in settlement topology.
*Source-checked: ATTESTED-PRIMARY · custody sha256 b64b12c6f480… — found in primary source*

**DeFiLlama protocols index** [✓ ATTESTED-PRIMARY]
DeFiLlama's protocols page indexes on-chain deployment metrics — cross-check for data-waist claims in tokenized settlement graphs.
*Source-checked: ATTESTED-PRIMARY · custody sha256 8fc8fa7211ff… — found in primary source*

**DeFiLlama Ethereum chain page** [✓ ATTESTED-PRIMARY]
DeFiLlama's Ethereum chain page documents L1 protocol activity — verifiable lane for on-chain data claims in settlement topology.
*Source-checked: ATTESTED-PRIMARY · custody sha256 c16436d1c69d… — found in primary source*
...
DeFiLlama data settlement pressure is elevated because tokenized fund issuers cite TVL and deployment metrics faster than VERIFY catalogs attestation of data freshness relative to audit-report publication dates. The engine reads unrealized Φ_S when DeFiLlama centrality exceeds vault evidence of on-chain metric coverage.

### Coherence (κ = 0.0185)

κ = 0.0185 reflects the engine's current **measurement coverage**, not DeFiLlama's actual institutional influence. With no vault records yet, the coherence score is derived purely from topology position — connection count and structural weight — without any attested observation data. The low value means the engine has not yet measured this entity's settlement activity, not that the entity lacks field presence.

The equilibrium attractor is κ = 1/φ ≈ 0.618. At current κ = 0.0185, DeFiLlama is **0.5995 below** equilibrium. Vault observations of DeFiLlama's rule outputs — rulemaking notices, enforcement actions, guidance documents — would directly raise κ toward the living zone [0.618, 0.678].

### Vault Coverage

No vault records yet for DeFiLlama. This is a gap in the field coverage. The engine recommends observation as the first action (see below).
...
**node:** `34539544`
**entity:** `DEFILLAMA_DATA`
**report_id:** `DEFILLAMA_DATA_20260702`
**canonical_report:** https://kaydeep0.github.io/eigenstate-research/reports/report.html?id=DEFILLAMA_DATA_20260702
...
| Entity dossier | [Entity dossier](https://kaydeep0.github.io/eigenstate-research/federation/dossier/DEFILLAMA_DATA.json) |
| Chain verify | [Chain verify](https://geniusflow-federation.vercel.app/api/chain) |
| This report | [This report](https://kaydeep0.github.io/eigenstate-research/reports/report.html?id=DEFILLAMA_DATA_20260702) |
...
- Dossier: https://kaydeep0.github.io/eigenstate-research/federation/dossier/DEFILLAMA_DATA.json
- Chain: https://geniusflow-federation.vercel.app/api/chain
- Canonical report: https://kaydeep0.github.io/eigenstate-research/reports/report.html?id=DEFILLAMA_DATA_20260702
...
**Vault:** No vault records yet for DeFiLlama in the current cycle — κ and Φ_S here are topology-derived until observations are attested. The field recommends observation as the first action.
...
*Generated: 2026-07-02T02:55:36 UTC by Eigenstate engine · DeFiLlama · 2026-07-02*