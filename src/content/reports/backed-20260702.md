...
The field is 0.1172 below equilibrium coherence. Each entity with measured vault activity raises the global PT toward 0.618. Backed Finance is one of 203 entities in the field without a complete observation record.
...
*Source-checked: ATTESTED-PRIMARY · custody sha256 6a868203e067… — found in primary source*

**DeFiLlama — Backed protocol page** [✓ ATTESTED-PRIMARY]
...
*Source-checked: ATTESTED-PRIMARY · custody sha256 33920c4fa071… — found in primary source*
...
κ = 0.0278 reflects the engine's current **measurement coverage**, not Backed Finance's actual institutional influence. With no vault records yet, the coherence score is derived purely from topology position — connection count and structural weight — without any attested observation data. The low value means the engine has not yet measured this entity's settlement activity, not that the entity lacks field presence.

The equilibrium attractor is κ = 1/φ ≈ 0.618. At current κ = 0.0278, Backed Finance is **0.5902 below** equilibrium. Vault observations of Backed Finance's rule outputs — rulemaking notices, enforcement actions, guidance documents — would directly raise κ toward the living zone [0.618, 0.678].

### Vault Coverage

No vault records yet for Backed Finance. This is a gap in the field coverage. The engine recommends observation as the first action (see below).
...
**node:** `34539544`
**entity:** `BACKED`
**report_id:** `BACKED_20260702`
**canonical_report:** https://kaydeep0.github.io/eigenstate-research/reports/report.html?id=BACKED_20260702
...
| Entity dossier | [Entity dossier](https://kaydeep0.github.io/eigenstate-research/federation/dossier/BACKED.json) |
| Chain verify | [Chain verify](https://geniusflow-federation.vercel.app/api/chain) |
| This report | [This report](https://kaydeep0.github.io/eigenstate-research/reports/report.html?id=BACKED_20260702) |
...
- Dossier: https://kaydeep0.github.io/eigenstate-research/federation/dossier/BACKED.json
- Chain: https://geniusflow-federation.vercel.app/api/chain
- Canonical report: https://kaydeep0.github.io/eigenstate-research/reports/report.html?id=BACKED_20260702
...
**Vault:** No vault records yet for Backed Finance in the current cycle — κ and Φ_S here are topology-derived until observations are attested. The field recommends observation as the first action.
...
*Generated: 2026-07-02T02:47:06 UTC by Eigenstate engine · Backed Finance · 2026-07-02*