---
id: "CITIGROUP_20260702"
entity_display: "Citigroup"
date: "July 02, 2026"
date_iso: "2026-07-02"
phi_s: 0.0233
kappa: 0.1667
...
| Field Coherence (κ) | 0.1667 | low coherence — entity has limited connection to measured field activity |
| Vault Records | 0 | No measurements yet — in observation queue |
| Topology Connections | 18 | Direct information flow links |
| Power Concentration Rank | #2 of 218 | Score: 0.16 |
...
The field is 0.1172 below equilibrium coherence. Each entity with measured vault activity raises the global PT toward 0.618. Citigroup is one of 203 entities in the field without a complete observation record.
...
Active signals the engine is tracking for Citigroup:

**Citigroup — global financial services** [✓ ATTESTED-PRIMARY]
Citigroup's corporate homepage identifies the firm as a leading global financial services company — the institutional anchor for custody, markets, and cross-border settlement in the topology.
*Source-checked: ATTESTED-PRIMARY · custody sha256 923848e0c4d8… — found in primary source*

**Citigroup global presence and institutional role** [✓ ATTESTED-PRIMARY]
Citigroup's about page describes its global footprint and role serving clients worldwide — the primary-source frame for how rule signals from US and EU regulators propagate through its custody and markets businesses.
*Source-checked: ATTESTED-PRIMARY · custody sha256 0b6a5c10d522… — found in primary source*

**Services for institutional clients — custody and markets** [✓ ATTESTED-PRIMARY]
Citigroup's services businesses page documents offerings for institutional clients — the bank-grade lane through which tokenized fund shares, stablecoin reserves, and RWA custody must route at scale.
*Source-checked: ATTESTED-PRIMARY · custody sha256 700e581f3fb1… — found in primary source*
...
Citigroup's settlement pressure is elevated because tokenized RWA and stablecoin flows are scaling faster than vault coverage of its custody, tokenization pilots, and cross-border settlement roles. The engine reads the gap between Citigroup's structural weight in the power graph — connections to SEC, OCC, Fed, BlackRock, and Circle — and incomplete observation of its digital-asset service lines as unrealized Φ_S.

### Coherence (κ = 0.1667)

κ = 0.1667 reflects the engine's current **measurement coverage**, not Citigroup's actual institutional influence. With no vault records yet, the coherence score is derived purely from topology position — connection count and structural weight — without any attested observation data. The low value means the engine has not yet measured this entity's settlement activity, not that the entity lacks field presence.

The equilibrium attractor is κ = 1/φ ≈ 0.618. At current κ = 0.1667, Citigroup is **0.4513 below** equilibrium. Vault observations of Citigroup's rule outputs — rulemaking notices, enforcement actions, guidance documents — would directly raise κ toward the living zone [0.618, 0.678].
...
- E = 4.60 (ΔI = 120.76 / A = 3.20)
- Capital-adjusted score: 100,258,801
- Estimated effort: 4h
- Action type: `connect`

## Concentration Analysis

Citigroup ranks **#2** in the field's power concentration with a score of 0.16 (field total: 0.88).
...
**node:** `34539544`
**entity:** `CITIGROUP`
**report_id:** `CITIGROUP_20260702`
**canonical_report:** https://kaydeep0.github.io/eigenstate-research/reports/report.html?id=CITIGROUP_20260702
...
| This report | [This report](https://kaydeep0.github.io/eigenstate-research/reports/report.html?id=CITIGROUP_20260702) |
...
- Canonical report: https://kaydeep0.github.io/eigenstate-research/reports/report.html?id=CITIGROUP_20260702
...
*Generated: 2026-07-02T04:07:34 UTC by Eigenstate engine · Citigroup · 2026-07-02*