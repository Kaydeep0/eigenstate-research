...
|--------|-------|---------|
| Settlement Pressure (Φ_S) | 3.2602 | high settlement pressure — this entity is pulling field energy without reciprocal observation |
...
*Source-checked: ATTESTED-PRIMARY · custody sha256 feee5a40fdd9… — found in primary source*
...
*Source-checked: ATTESTED-PRIMARY · custody sha256 573dea1ed642… — found in primary source*
...
*Source-checked: ATTESTED-PRIMARY · custody sha256 813a6f6ad854… — found in primary source*

## Field Position Analysis

### Settlement Pressure (Φ_S = 3.2602)
...
κ = 0.0001 reflects the engine's current **measurement coverage**, not FATF Travel Rule's actual institutional influence. With no vault records yet, the coherence score is derived purely from topology position — connection count and structural weight — without any attested observation data. The low value means the engine has not yet measured this entity's settlement activity, not that the entity lacks field presence.

The equilibrium attractor is κ = 1/φ ≈ 0.618. At current κ = 0.0001, FATF Travel Rule is **0.6179 below** equilibrium. Vault observations of FATF Travel Rule's rule outputs — rulemaking notices, enforcement actions, guidance documents — would directly raise κ toward the living zone [0.618, 0.678].
...
**node:** `34539544`
**entity:** `TRAVEL_RULE`
**report_id:** `TRAVEL_RULE_20260701`
**canonical_report:** https://kaydeep0.github.io/eigenstate-research/reports/report.html?id=TRAVEL_RULE_20260701
...
| This report | [This report](https://kaydeep0.github.io/eigenstate-research/reports/report.html?id=TRAVEL_RULE_20260701) |
...
- Canonical report: https://kaydeep0.github.io/eigenstate-research/reports/report.html?id=TRAVEL_RULE_20260701
...
*Generated: 2026-07-01T18:04:59 UTC by Eigenstate engine · FATF Travel Rule · 2026-07-01*