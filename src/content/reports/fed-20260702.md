...
|--------|-------|---------|
| Settlement Pressure (Φ_S) | 0.6800 | elevated settlement pressure — significant information gap relative to field weight |
...
| Gravitational Mass | 115.0 (regulatory) | Reach: 5 layers |
...
*Source-checked: ATTESTED-PRIMARY · custody sha256 3df5a847bc74… — found in primary source*
...
*Source-checked: ATTESTED-PRIMARY · custody sha256 ee50da70dfed… — found in primary source*
...
*Source-checked: ATTESTED-PRIMARY · custody sha256 f31c8f269dda… — found in primary source*

## Field Position Analysis

### Settlement Pressure (Φ_S = 0.6800)
...
κ = 0.0014 reflects the engine's current **measurement coverage**, not Federal Reserve's actual institutional influence. With no vault records yet, the coherence score is derived purely from topology position — connection count and structural weight — without any attested observation data. The low value means the engine has not yet measured this entity's settlement activity, not that the entity lacks field presence.

The equilibrium attractor is κ = 1/φ ≈ 0.618. At current κ = 0.0014, Federal Reserve is **0.6166 below** equilibrium. Vault observations of Federal Reserve's rule outputs — rulemaking notices, enforcement actions, guidance documents — would directly raise κ toward the living zone [0.618, 0.678].
...
- E = 4.00 (ΔI = 27.53 / A = 4.20)
- Capital-adjusted score: 24,755,848
- Estimated effort: 6h
- Action type: `deploy`
...
**node:** `34539544`
**entity:** `FED`
**report_id:** `FED_20260702`
**canonical_report:** https://kaydeep0.github.io/eigenstate-research/reports/report.html?id=FED_20260702
...
| This report | [This report](https://kaydeep0.github.io/eigenstate-research/reports/report.html?id=FED_20260702) |
...
- Canonical report: https://kaydeep0.github.io/eigenstate-research/reports/report.html?id=FED_20260702
...
*Generated: 2026-07-02T15:01:34 UTC by Eigenstate engine · Federal Reserve · 2026-07-02*