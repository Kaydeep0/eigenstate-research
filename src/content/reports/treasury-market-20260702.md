...
| Power Concentration Rank | #3 of 218 | Score: 0.13 |
...
The field is 0.1172 below equilibrium coherence. Each entity with measured vault activity raises the global PT toward 0.618. US Treasury Market is one of 203 entities in the field without a complete observation record.
...
*Source-checked: ATTESTED-PRIMARY · custody sha256 b912076aa0b7… — found in primary source*
...
*Source-checked: ATTESTED-PRIMARY · custody sha256 10afb3f9c29b… — found in primary source*
...
*Source-checked: ATTESTED-PRIMARY · custody sha256 fb3ab3cd9c7d… — found in primary source*
...
κ = 0.1944 reflects the engine's current **measurement coverage**, not US Treasury Market's actual institutional influence. With no vault records yet, the coherence score is derived purely from topology position — connection count and structural weight — without any attested observation data. The low value means the engine has not yet measured this entity's settlement activity, not that the entity lacks field presence.

The equilibrium attractor is κ = 1/φ ≈ 0.618. At current κ = 0.1944, US Treasury Market is **0.4236 below** equilibrium. Vault observations of US Treasury Market's rule outputs — rulemaking notices, enforcement actions, guidance documents — would directly raise κ toward the living zone [0.618, 0.678].
...
US Treasury Market ranks **#3** in the field's power concentration with a score of 0.13 (field total: 0.88).
...
**report_id:** `TREASURY_MARKET_20260702`
**canonical_report:** https://kaydeep0.github.io/eigenstate-research/reports/report.html?id=TREASURY_MARKET_20260702
...
| This report | [This report](https://kaydeep0.github.io/eigenstate-research/reports/report.html?id=TREASURY_MARKET_20260702) |
...
- Canonical report: https://kaydeep0.github.io/eigenstate-research/reports/report.html?id=TREASURY_MARKET_20260702
...
*Generated: 2026-07-02T04:54:35 UTC by Eigenstate engine · US Treasury Market · 2026-07-02*