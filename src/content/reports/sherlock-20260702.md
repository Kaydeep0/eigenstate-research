---
id: "SHERLOCK_20260702"
entity_display: "Sherlock"
date: "July 02, 2026"
date_iso: "2026-07-02"
phi_s: 0.02
kappa: 0.0093
vault_records: 0
entity_codename: "SHERLOCK"
display_kind: "data_provider"
facet_label: "Data / Oracles"
public_default: true
demoted: false
---
# Sherlock: Field Position Report
...
The field is 0.1172 below equilibrium coherence. Each entity with measured vault activity raises the global PT toward 0.618. Sherlock is one of 203 entities in the field without a complete observation record.

## What Is Sherlock

Sherlock is a smart contract audit and coverage platform — coordinating security researchers and audit contests for DeFi and tokenized asset protocols on Ethereum. For spread-capture topology, Sherlock is the contest-audit waist where settlement contracts must align with attested review coverage before issuer products reach production.
...
Active signals the engine is tracking for Sherlock:

**Sherlock — audit platform homepage** [✓ ATTESTED-PRIMARY]
Sherlock's homepage documents smart contract audit and coverage services — primary anchor for Sherlock claims in settlement topology.
*Source-checked: ATTESTED-PRIMARY · custody sha256 2600712d140f… — found in primary source*

**Sherlock documentation** [✓ ATTESTED-PRIMARY]
Sherlock's documentation describes audit contest and coverage workflows — cross-check for contest-audit claims in tokenized settlement graphs.
*Source-checked: ATTESTED-PRIMARY · custody sha256 3c46799d47dd… — found in primary source*

**Sherlock audit coverage documentation** [✓ ATTESTED-PRIMARY]
Sherlock's audit documentation describes protocol review coverage — verifiable lane for audit-waist claims in settlement topology.
*Source-checked: ATTESTED-PRIMARY · custody sha256 2077a2f94f50… — found in primary source*
...
Sherlock settlement pressure is elevated because tokenized fund and DeFi protocols publish contest audit coverage faster than VERIFY catalogs attestation of review freshness per upgrade cycle. The engine reads unrealized Φ_S when Sherlock centrality exceeds vault evidence of audit coverage on Ethereum settlement rails.

### Coherence (κ = 0.0093)

κ = 0.0093 reflects the engine's current **measurement coverage**, not Sherlock's actual institutional influence. With no vault records yet, the coherence score is derived purely from topology position — connection count and structural weight — without any attested observation data. The low value means the engine has not yet measured this entity's settlement activity, not that the entity lacks field presence.

The equilibrium attractor is κ = 1/φ ≈ 0.618. At current κ = 0.0093, Sherlock is **0.6087 below** equilibrium. Vault observations of Sherlock's rule outputs — rulemaking notices, enforcement actions, guidance documents — would directly raise κ toward the living zone [0.618, 0.678].

### Vault Coverage

No vault records yet for Sherlock. This is a gap in the field coverage. The engine recommends observation as the first action (see below).
...
**node:** `34539544`
**entity:** `SHERLOCK`
**report_id:** `SHERLOCK_20260702`
**canonical_report:** https://kaydeep0.github.io/eigenstate-research/reports/report.html?id=SHERLOCK_20260702
...
| Entity dossier | [Entity dossier](https://kaydeep0.github.io/eigenstate-research/federation/dossier/SHERLOCK.json) |
| Chain verify | [Chain verify](https://geniusflow-federation.vercel.app/api/chain) |
| This report | [This report](https://kaydeep0.github.io/eigenstate-research/reports/report.html?id=SHERLOCK_20260702) |
...
- Dossier: https://kaydeep0.github.io/eigenstate-research/federation/dossier/SHERLOCK.json
- Chain: https://geniusflow-federation.vercel.app/api/chain
- Canonical report: https://kaydeep0.github.io/eigenstate-research/reports/report.html?id=SHERLOCK_20260702
...
**Vault:** No vault records yet for Sherlock in the current cycle — κ and Φ_S here are topology-derived until observations are attested. The field recommends observation as the first action.
...
*Generated: 2026-07-02T02:52:41 UTC by Eigenstate engine · Sherlock · 2026-07-02*