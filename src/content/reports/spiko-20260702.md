---
id: "SPIKO_20260702"
entity_display: "Spiko"
date: "July 02, 2026"
date_iso: "2026-07-02"
phi_s: 0.02
kappa: 0.0185
vault_records: 0
entity_codename: "SPIKO"
display_kind: "issuer_protocol"
facet_label: "Issuers / Protocols"
public_default: true
demoted: false
---
# Spiko: Field Position Report
...
The field is 0.1172 below equilibrium coherence. Each entity with measured vault activity raises the global PT toward 0.618. Spiko is one of 203 entities in the field without a complete observation record.

## What Is Spiko

Spiko is a European tokenized money-market fund issuer — deploying on-chain tokens backed by regulated fund shares under EU jurisdiction, connected to Western Europe settlement rails alongside Backed and other RWA issuers. For spread-capture topology, Spiko is an EU issuer waist where tokenized product deployment must align with attested disclosure and MiCA jurisdiction evidence on Ethereum and Base.
...
Active signals the engine is tracking for Spiko:

**Spiko — tokenized fund issuer homepage** [✓ ATTESTED-PRIMARY]
Spiko's homepage documents tokenized money-market fund products — primary anchor for Spiko issuer claims in settlement topology.
*Source-checked: ATTESTED-PRIMARY · custody sha256 cbc960f46197… — found in primary source*

**Spiko documentation** [✓ ATTESTED-PRIMARY]
Spiko docs describe tokenized fund mechanics and product structure — cross-check for EU issuer claims in tokenized settlement graphs.
*Source-checked: ATTESTED-PRIMARY · custody sha256 67db312f58e6… — found in primary source*

**RWA.xyz — Spiko asset page** [✓ ATTESTED-PRIMARY]
RWA.xyz's Spiko page documents on-chain tokenized fund activity — verifiable open-data lane for Spiko issuer products in settlement topology.
...
Spiko settlement pressure is elevated because EU tokenized fund issuance scales on public chains faster than VERIFY catalogs per-product attestation of reserve backing and regulatory disclosure. The engine reads unrealized Φ_S when Spiko centrality exceeds vault evidence of issuer deployment and EU jurisdiction compliance events.

### Coherence (κ = 0.0185)

κ = 0.0185 reflects the engine's current **measurement coverage**, not Spiko's actual institutional influence. With no vault records yet, the coherence score is derived purely from topology position — connection count and structural weight — without any attested observation data. The low value means the engine has not yet measured this entity's settlement activity, not that the entity lacks field presence.

The equilibrium attractor is κ = 1/φ ≈ 0.618. At current κ = 0.0185, Spiko is **0.5995 below** equilibrium. Vault observations of Spiko's rule outputs — rulemaking notices, enforcement actions, guidance documents — would directly raise κ toward the living zone [0.618, 0.678].

### Vault Coverage

No vault records yet for Spiko. This is a gap in the field coverage. The engine recommends observation as the first action (see below).
...
**node:** `34539544`
**entity:** `SPIKO`
**report_id:** `SPIKO_20260702`
**canonical_report:** https://kaydeep0.github.io/eigenstate-research/reports/report.html?id=SPIKO_20260702
...
| Entity dossier | [Entity dossier](https://kaydeep0.github.io/eigenstate-research/federation/dossier/SPIKO.json) |
| Chain verify | [Chain verify](https://geniusflow-federation.vercel.app/api/chain) |
| This report | [This report](https://kaydeep0.github.io/eigenstate-research/reports/report.html?id=SPIKO_20260702) |
...
- Dossier: https://kaydeep0.github.io/eigenstate-research/federation/dossier/SPIKO.json
- Chain: https://geniusflow-federation.vercel.app/api/chain
- Canonical report: https://kaydeep0.github.io/eigenstate-research/reports/report.html?id=SPIKO_20260702
...
**Vault:** No vault records yet for Spiko in the current cycle — κ and Φ_S here are topology-derived until observations are attested. The field recommends observation as the first action.
...
*Generated: 2026-07-02T03:55:01 UTC by Eigenstate engine · Spiko · 2026-07-02*