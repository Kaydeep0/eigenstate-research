---
id: "DUNE_DATA_20260702"
entity_display: "Dune Analytics"
date: "July 02, 2026"
date_iso: "2026-07-02"
phi_s: 0.02
kappa: 0.0093
vault_records: 0
entity_codename: "DUNE_DATA"
display_kind: "data_provider"
facet_label: "Data / Oracles"
public_default: true
demoted: false
---
# Dune Analytics: Field Position Report
...
The field is 0.1172 below equilibrium coherence. Each entity with measured vault activity raises the global PT toward 0.618. Dune Analytics is one of 203 entities in the field without a complete observation record.

## What Is Dune Analytics

Dune Analytics is an on-chain analytics platform — providing SQL-queryable dashboards and community-built metrics for DeFi, stablecoin, and tokenized asset activity on Ethereum and Base. For spread-capture topology, Dune is the analytics waist where settlement claims must align with attested queryable on-chain evidence.
...
Active signals the engine is tracking for Dune Analytics:

**Dune Analytics — on-chain analytics homepage** [✓ ATTESTED-PRIMARY]
Dune's homepage documents on-chain analytics and dashboard tools — primary anchor for Dune data claims in settlement topology.
*Source-checked: ATTESTED-PRIMARY · custody sha256 a757893760e7… — found in primary source*

**Dune documentation** [✓ ATTESTED-PRIMARY]
Dune docs describe query workflows and data access — cross-check for analytics-waist claims in tokenized settlement graphs.
*Source-checked: ATTESTED-PRIMARY · custody sha256 b1b682380a01… — found in primary source*

**Dune discover — trending analytics** [✓ ATTESTED-PRIMARY]
Dune's discover page indexes community analytics dashboards — verifiable lane for on-chain data claims in settlement topology.
*Source-checked: ATTESTED-PRIMARY · custody sha256 fb32411631dc… — found in primary source*
...
Dune data settlement pressure is elevated because tokenized fund issuers publish custom dashboards faster than VERIFY catalogs attestation of query freshness relative to contract upgrade cycles. The engine reads unrealized Φ_S when Dune centrality exceeds vault evidence of on-chain analytics coverage.

### Coherence (κ = 0.0093)

κ = 0.0093 reflects the engine's current **measurement coverage**, not Dune Analytics's actual institutional influence. With no vault records yet, the coherence score is derived purely from topology position — connection count and structural weight — without any attested observation data. The low value means the engine has not yet measured this entity's settlement activity, not that the entity lacks field presence.

The equilibrium attractor is κ = 1/φ ≈ 0.618. At current κ = 0.0093, Dune Analytics is **0.6087 below** equilibrium. Vault observations of Dune Analytics's rule outputs — rulemaking notices, enforcement actions, guidance documents — would directly raise κ toward the living zone [0.618, 0.678].

### Vault Coverage

No vault records yet for Dune Analytics. This is a gap in the field coverage. The engine recommends observation as the first action (see below).
...
**node:** `34539544`
**entity:** `DUNE_DATA`
**report_id:** `DUNE_DATA_20260702`
**canonical_report:** https://kaydeep0.github.io/eigenstate-research/reports/report.html?id=DUNE_DATA_20260702
...
| Entity dossier | [Entity dossier](https://kaydeep0.github.io/eigenstate-research/federation/dossier/DUNE_DATA.json) |
| Chain verify | [Chain verify](https://geniusflow-federation.vercel.app/api/chain) |
| This report | [This report](https://kaydeep0.github.io/eigenstate-research/reports/report.html?id=DUNE_DATA_20260702) |
...
- Dossier: https://kaydeep0.github.io/eigenstate-research/federation/dossier/DUNE_DATA.json
- Chain: https://geniusflow-federation.vercel.app/api/chain
- Canonical report: https://kaydeep0.github.io/eigenstate-research/reports/report.html?id=DUNE_DATA_20260702
...
**Vault:** No vault records yet for Dune Analytics in the current cycle — κ and Φ_S here are topology-derived until observations are attested. The field recommends observation as the first action.
...
*Generated: 2026-07-02T03:06:45 UTC by Eigenstate engine · Dune Analytics · 2026-07-02*