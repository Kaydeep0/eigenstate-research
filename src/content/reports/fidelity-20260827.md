...
*projection_version:* `geniusflow.public_entity_projection.v1` · *source_snapshot_id:* `sha256:d3c06e9914795f01cc24c7fb7cc425b47e689549c064e6d0c0877a43a49d7e72` · *identity_contract:* `geniusflow.observer_identity.v1`
...
- DERIVED
- Last observed: 2026-08-27T22:08:08.717382+00:00
...
- source_snapshot_id: `sha256:d3c06e9914795f01cc24c7fb7cc425b47e689549c064e6d0c0877a43a49d7e72`
...
*Source-checked: ATTESTED-PRIMARY · status_at_publish=ATTESTED-PRIMARY · custody sha256 d57d2f19859d…. found near location anchor in primary source*

**FDIF,  Fidelity Digital Interest Fund on-chain** [✓ ATTESTED-DERIVED]
...
*Source-checked: ATTESTED-DERIVED · status_at_publish=ATTESTED-DERIVED · custody sha256 44d560996542…. found near location anchor in primary source*
...
*Source-checked: ATTESTED-PRIMARY · status_at_publish=ATTESTED-PRIMARY · custody sha256 568c317117a9…. found near location anchor in primary source*
...
κ = 0.1563 reflects the engine's **publish-time measurement coverage**, not Fidelity's actual institutional influence. When vault@publish is 0, the coherence score is derived from topology position (connection count and structural weight) without cycle-vault rows in this publish. Live M1 ledger obs on the Pages hero may still be non-zero; do not treat vault@publish = 0 as 'no measurements exist'.

The equilibrium attractor is κ = 1/φ ≈ 0.618. At publish κ = 0.1563, Fidelity is **0.4617 below** equilibrium. Attested observations of Fidelity's rule outputs (rulemaking notices, enforcement actions, guidance documents) would raise κ toward the living zone [0.618, 0.678].
...
**1. Build topology data licensing product for institutional clients**

- E = 0.00 (ΔI = 102.14 / A = 5.10)
- Capital-adjusted score: 2,411,292
- Estimated effort: 6h
- Action type: `build`
...
**Human pages:**
- [Canonical report](https://kaydeep0.github.io/eigenstate-research/reports/fidelity-20260827/)
- [Entity dossier (HTML)](https://kaydeep0.github.io/eigenstate-research/dossier/FIDELITY/)
- [Methodology](https://kaydeep0.github.io/eigenstate-research/METHODOLOGY.md)
- [Numbers glossary](https://kaydeep0.github.io/eigenstate-research/METHODOLOGY.md#numbers-glossary)
- [Verify walkthrough](https://kaydeep0.github.io/eigenstate-research/verify-walkthrough/)
...
*Generated: 2026-08-27T22:20:20 UTC by Eigenstate engine · Fidelity · 2026-08-27*