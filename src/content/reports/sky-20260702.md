...
The field is 0.1172 below equilibrium coherence. Each entity with measured vault activity raises the global PT toward 0.618. Sky Protocol does not yet have a complete observation record on the M1 topology (199 entities).
...
*Source-checked: ATTESTED-PRIMARY · custody sha256 e31c460fa728… — found in primary source*
...
*Source-checked: ATTESTED-PRIMARY · custody sha256 fae1b7bd7e7b… — found in primary source*

**Maker — predecessor protocol** [✓ ATTESTED-PRIMARY]
...
*Source-checked: ATTESTED-PRIMARY · custody sha256 697ac6a56ad8… — found in primary source*
...
κ = 0.0093 reflects the engine's current **measurement coverage**, not Sky Protocol's actual institutional influence. With no vault records yet, the coherence score is derived purely from topology position — connection count and structural weight — without any attested observation data. The low value means the engine has not yet measured this entity's settlement activity, not that the entity lacks field presence.

The equilibrium attractor is κ = 1/φ ≈ 0.618. At current κ = 0.0093, Sky Protocol is **0.6087 below** equilibrium. Vault observations of Sky Protocol's rule outputs — rulemaking notices, enforcement actions, guidance documents — would directly raise κ toward the living zone [0.618, 0.678].

### Vault Coverage

No vault records yet for Sky Protocol. This is a gap in the field coverage. The engine recommends observation as the first action (see below).
...
**node:** `34539544`
**entity:** `SKY`
**report_id:** `SKY_20260702`
**canonical_report:** https://kaydeep0.github.io/eigenstate-research/reports/report.html?id=SKY_20260702
...
| Entity dossier | [Entity dossier](https://kaydeep0.github.io/eigenstate-research/federation/dossier/SKY.json) |
| Chain verify | [Chain verify](https://geniusflow-federation.vercel.app/api/chain) |
| This report | [This report](https://kaydeep0.github.io/eigenstate-research/reports/report.html?id=SKY_20260702) |
...
- Dossier: https://kaydeep0.github.io/eigenstate-research/federation/dossier/SKY.json
- Chain: https://geniusflow-federation.vercel.app/api/chain
- Canonical report: https://kaydeep0.github.io/eigenstate-research/reports/report.html?id=SKY_20260702
...
**Vault:** No vault records yet for Sky Protocol in the current cycle — κ and Φ_S here are topology-derived until observations are attested. The field recommends observation as the first action.
...
*Generated: 2026-07-02T04:52:56 UTC by Eigenstate engine · Sky Protocol · 2026-07-02*