...
The field is 0.2361 below equilibrium coherence. Each entity with measured vault activity raises the global PT toward 0.618. EU Regulators does not yet have a complete observation record on the M1 topology (199 entities).
...
### Settlement Pressure (Φ_S = 1.9103)
