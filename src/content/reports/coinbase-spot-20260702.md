---
id: "COINBASE_SPOT_20260702"
entity_display: "Coinbase Advanced Trade (spot)"
date: "July 02, 2026"
date_iso: "2026-07-02"
phi_s: 0.02
kappa: 0.0741
vault_records: 0
entity_codename: "COINBASE_SPOT"
display_kind: "issuer_protocol"
facet_label: "Issuers / Protocols"
public_default: true
demoted: false
---
# Coinbase Advanced Trade (spot): Field Position Report
...
The field is 0.1172 below equilibrium coherence. Each entity with measured vault activity raises the global PT toward 0.618. Coinbase Advanced Trade (spot) is one of 203 entities in the field without a complete observation record.

## What Is Coinbase Advanced Trade (spot)

Coinbase spot markets are the US-regulated cash trading venue on Coinbase Advanced Trade — where retail and institutional participants exchange crypto for fiat before custody or tokenized-product settlement. For spread-capture passthrough topology, Coinbase spot is the on-ramp waist paired with tokenized-treasury passthrough products.
...
Active signals the engine is tracking for Coinbase Advanced Trade (spot):
...
*Source-checked: ATTESTED-PRIMARY · custody sha256 63e417ebd96e… — found in primary source*
...
No vault records yet for Coinbase Advanced Trade (spot). This is a gap in the field coverage. The engine recommends observation as the first action (see below).
...
**node:** `34539544`
**entity:** `COINBASE_SPOT`
**report_id:** `COINBASE_SPOT_20260702`
**canonical_report:** https://kaydeep0.github.io/eigenstate-research/reports/report.html?id=COINBASE_SPOT_20260702
...
**Vault:** No vault records yet for Coinbase Advanced Trade (spot) in the current cycle — κ and Φ_S here are topology-derived until observations are attested. The field recommends observation as the first action.
